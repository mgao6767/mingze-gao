...
@goodman-bacon_2021 shows that, in this case, TWFE estimate of $\beta$ in Equation (1) above is in fact a (complicated) weighted-average of all possible $2\times2$ DiD estimates, which leads to __bias__:
