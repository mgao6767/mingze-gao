...
Create a log file name `stata101.log` in the current working directory. The `replace` option asks Stata to replace the log file if it already exists. Until `. log close`, everything displayed in __Results__ will be saved in the log file.
