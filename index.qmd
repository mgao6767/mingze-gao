...
[Mingze Gao](https://mingze-gao.com), aka [Adrian](https://adrian-gao.com), is a **Lecturer in Finance** at the Macquarie Business School (MQBS), **Deputy Director** of the [Macquarie University FinTech and Banking Research Centre](https://www.mq.edu.au/research/research-centres-groups-and-facilities/centres/fintech-and-banking), and a visiting scholar at the University of Sydney. With a focus on banking and corporate finance, his work has been published at journals including _Journal of Corporate Finance_, _Journal of Banking & Finance_, among others, and/or presented at leading conferences such as WFA, SFS Cavalcade, EFA (poster), FMA, FIRN, and AFBC. He serves as an ad hoc referee at multiple ABDC-A*/A journals. He is an elected academic staff member of the MQBS Faculty Board.
...
- 2026-09-14: My paper [The 52-Week High Liquidity Mirage: How Behavioral Convergence Impairs Price Discovery](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3925756) with Joshua Della Vedova, Andrew Grant, Joakim Westerholm and Barbara Bliss has been accepted for publication at the ***Journal of Banking & Finance***.
- 2026-05-13: My appointment as a **Visiting Fellow in the School of Finance at the University of Sydney** has been extended until the end of 2028.
- 2026-04-09: My paper [Debt Contracting Relevance of Earnings Downside Risk](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5784962), with Steve Lim and Vassil Mihov has been accepted for presentation at the American Accounting Association Global Connect (formerly Annual Meeting) 2026.
- 2026-01-22: My paper [Real Estate Collateral, Lender Screening, and M&A Performance](https://doi.org/10.1016/j.jcorpfin.2026.102962) with with Thanh Son Luong and Buhui Qiu has been accepted for publication at the ***Journal of Corporate Finance***.
- 2025-12-16: I will be a member of the assessment panel for the **ECR Enabling Scheme 2026**. Looking forward to reading some great applications!
- 2025-12-03: Proud to have been nominated by my students for the new *Students’ Choice Award for Outstanding Contributions to Education and the Student Experience*.
...
```{=html}
<script>
// Fold the news list to the latest items; without JavaScript everything stays visible.
document.addEventListener("DOMContentLoaded", () => {
  const SHOW = 10;
  const list = document.querySelector("#news > ul");
  if (!list) return;
  const extra = [...list.children].slice(SHOW);
  ...
  const setFolded = (folded) => {
    extra.forEach((li) => (li.hidden = folded));
    btn.textContent = folded ? `Show all (${list.children.length})` : "Show fewer";
    btn.setAttribute("aria-expanded", String(!folded));
  };
  btn.addEventListener("click", () => {
    const fold = !extra[0].hidden;
    setFolded(fold);
    if (fold) btn.scrollIntoView({ block: "nearest" });
  });
  list.after(btn);
  setFolded(true);
});
