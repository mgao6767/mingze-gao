...
In today's workshop, we will touch on some key aspects of bank accounting. We will use the Python package I developed, [BRMS (Bank Risk Management Simulation)](https://github.com/mgao6767/brms/), to have a hands-on experience of how a bank's balance sheet is shaped by various transactions.
...
In this worksop, we have an overview of some simple bank accounting to showcase how various transactions affect a bank's income statement and balance sheet. This provides a foundational understanding of 
