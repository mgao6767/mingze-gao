...
Central to bank risk management is credit risk, as discussed in [Week 6](https://mingze-gao.com/teaching/AFIN8003/2026S2/Week6) and [Week 7](https://mingze-gao.com/teaching/AFIN8003/2026S2/Week7).
...
U.S. secondary loan trading reached a record **US\$971 billion in 2025**, according to the Loan Syndications and Trading Association (LSTA). This market barely existed in 1990.
:::
...
- have floating rates tied to a benchmark — historically LIBOR; since LIBOR ended (sterling in 2021, US dollar in 2023), predominantly **SOFR** (Secured Overnight Financing Rate) in the U.S. and risk-free rates such as **SONIA** in the U.K.
...
If the selling FI goes bankrupt, a participation buyer must show the participation was a *true sale*; otherwise it may be treated as just another unsecured creditor of that FI. An assignment buyer owns the loan outright. When **Lehman Brothers** failed in 2008, participations it had sold on standard LSTA terms were treated as true sales, so the underlying loans stayed out of its bankruptcy estate.
:::
...
- Investment banks
- **Vulture funds** (specialised funds that invest in distressed loans — they bought billions of dollars of distressed debt of Argentina and Greece)
...
After the U.K. nationalised **Northern Rock** (2008) and **Bradford & Bingley** (2008), HM Treasury folded their toxic mortgage books into **UKAR** in 2010. At its peak, UKAR managed roughly **£116 billion** of assets, mostly mortgages — making it temporarily one of the largest mortgage holders in the U.K.

UKAR's job was *not* to lend, but to **sell**. It auctioned loan portfolios to private investors over a decade — e.g., **Cerberus Capital Management** paid roughly £13 billion in 2015 for a chunk of the Northern Rock book. UKAR repaid the £48.7 billion of government loans in full by 2019 and sold its last assets in 2021.
:::
...
Over the next eight years, Citi Holdings *sold* these assets into the secondary loan market and to private-equity / hedge-fund buyers, shrinking the book by more than 90% (to US\$54 billion by the end of 2016). From 2017, Citi stopped reporting it as a separate segment. It is the canonical example of a bank using a *good bank-bad bank* split to clean up *without* requiring a separate legal entity or government takeover.
:::
...
Under Basel III, a B-rated leveraged loan attracts a much higher risk weight than an AAA tranche of a CLO that holds the *same loan*. So a bank can originate a loan, sell it into a CLO, then buy back the AAA tranche, keeping the safest slice of the credit risk at a fraction of the capital cost. @irani_rise_2021 find that banks short of capital retain less of such loans, and nonbanks step in.
:::
...
The whole point of using a separate SPV/SIV is **bankruptcy remoteness**: if the originating bank fails, the assets inside the SPV are *not* part of the bank's bankruptcy estate. Investors in the ABS keep getting paid. Off-balance-sheet treatment also let banks hold little regulatory capital against these exposures, a loophole regulators tightened after 2008. Enron, a non-bank, used similar off-balance-sheet entities to hide debt before it collapsed in 2001.
:::
...
::: {.callout-note}
Pass-throughs are the primary mechanism for securitisation. The U.S. agency MBS market — issued by Fannie Mae, Freddie Mac, and Ginnie Mae — exceeds **US\$9 trillion outstanding**, making it one of the largest fixed-income markets in the world.
:::
...
Think of the classes as queuing for principal. Every class receives its coupon interest each period, but all principal payments, scheduled and prepaid, go to Class A until it is fully repaid, then to Class B, then to Class C. Credit tranching is a different idea: in CDOs, CLOs and private-label MBS, losses hit the most junior (*equity*) tranche first.
:::
...
%%| fig-width: 6.3
flowchart LR
    P["Mortgage Pool"] --> I["Interest"]
    P --> PR["Principal + Prepayments"]
...
Australian banks are major issuers of **covered bonds** — APRA allows ADIs to issue covered bonds backed by a segregated pool of high-quality mortgages, capped at 8% of Australian assets. Issuance was particularly strong in 2023, as banks refinanced the RBA's **Term Funding Facility**.
:::
...
- In **November 2018**, the Federal Reserve's first Financial Stability Report flagged leveraged loans as a financial stability risk, with similar warnings from the **Bank of England, IMF, and BIS**.
- The U.S. leveraged loan market roughly doubled in the six years to 2018, and the share of new large loans to **highly leveraged borrowers** (debt above 6× EBITDA) rose past its 2007 peak.
- The U.S. leveraged loan market reached about **US\$1.55 trillion** at the end of 2025, and the **U.S. CLO market exceeds US\$1 trillion outstanding** — comparable in scale to the 2007 subprime mortgage market.
...
3. **SPVs disappear** when assets mature; **SIVs act like banks** with no deposit insurance, so they face run risk.
4. Pass-throughs, CMOs, and MBBs each handle prepayment and balance-sheet treatment differently.
5. **CLOs are the new subprime** — same scale, same regulatory worry, but (so far) better investor protections in the CLO structure.
