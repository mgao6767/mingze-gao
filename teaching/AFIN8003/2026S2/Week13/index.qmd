...
3. **The regulator is always one crisis behind.** Basel I followed the 1980s loan-loss cycle. Basel III followed the GFC. CPS 230 (operational resilience) followed COVID and cloud incidents. The *next* rulebook will tell us what just broke.
:::
...
::: {.callout-tip title="The purpose of capital regulation"}
...
- Additional capital charges for __market risk__ and __operational risk__.
  - They are summarised below; the unit assesses only RWA for credit risk.
:::
...
- **Internal ratings-based (IRB)** — used by large DIs (in Australia, six of the largest banks).
...
1. RWA for credit risk (Week 3)
2. RWA for market risk. Can be calculated using two approaches:[^rwa-mkt-risk]
   1. Standardized approach proposed by regulators. Revised standards (FRTB) published in 2016 and finalised in 2019.
...
This unit assesses only the RWA for credit risk.
:::
...
One of the key functions performed by financial institutions (especially depository institutions) is __maturity transformation__. For DIs, they take short-term deposits from depositors and make long-term loans to borrowers. As a result,
...
For $c = 95\%$, ES is the average loss in the worst 5% of outcomes.
...
- This means that the ES of a portfolio is never greater than the sum of the individual positions' ESs — consistent with diversification.
- VaR lacks this property: the VaR of a combined portfolio can *exceed* the sum of the individual VaRs.
...
- Regulations limit exposure to any single borrower.
...
The most important type of credit derivative.
...
2. **Lender of last resort** — central-bank lending to solvent banks against collateral, so a run does not force fire sales.
...
- **Supply** of ES balances is set by the RBA's operations.

**Pre-COVID (scarce reserves):** the RBA managed ES supply via daily **repurchase agreements (repos)** to keep the cash rate near target.

**Now (ample reserves):** banks get as many ES balances as they bid for.

- **Weekly open market operation** — full-allotment repos at the cash rate target plus 10 bp.
- **Standing overnight repo facility** — at the cash rate target plus 25 bp.
- ES balances earn the cash rate target minus 10 bp.
...
Nominal interest rate $R$ is basically the sum of inflation $\pi$ and real interest rate $r$ (the **Fisher equation**).
...
In its relative form, PPP says the percentage change in the exchange rate is approximately the inflation gap. For yen per US dollar:
...
Covered **interest rate parity (IRP)** compares two risk-free ways to invest A\$1 for one year:

1. Deposit it in Australia at $r_{AUD}$.
2. Buy euros at the spot rate $S_{AUD/EUR}$, deposit them at $r_{EUR}$, and sell the euros forward today at $F_{AUD/EUR}$.

With no arbitrage, both must pay the same:

$$
1 + r_{AUD} = \frac{(1 + r_{EUR})\,F_{AUD/EUR}}{S_{AUD/EUR}}
\quad\Longleftrightarrow\quad
F_{AUD/EUR} = S_{AUD/EUR} \times \frac{1 + r_{AUD}}{1 + r_{EUR}}
$$

The forward rate is pinned by today's interest rates, not by a forecast.
...
- Beyond FX risk, holding assets in a foreign country also exposes FIs to country or __sovereign risk__.
    - e.g., a foreign corporation may be unable to repay the principal or interest on a loan even if it wants to.
...
Today, much lending instead follows the **originate-to-distribute** model:
...
The originate-to-distribute model fuelled the **2008 global financial crisis**: once banks no longer held the loans they originated, their incentive to screen and monitor borrowers collapsed. Subprime mortgages were originated, securitised and sold, yet much of the risk came back to banks through tranches they kept and vehicles they sponsored.
:::
...
- floating-rate, historically tied to LIBOR; since LIBOR ended (sterling in 2021, US dollar in 2023), predominantly **SOFR** in the U.S. and **SONIA** in the U.K.
...
::::
:::: {.column}
**Good bank / bad bank** carve-outs are a special kind of loan sale: distressed loans move into a separate unit whose job is to sell them off over time.
::::
:::

## Reasons for loan sales
...
::: {.callout-important title="The SIV problem"}
SIVs hold long-term assets funded with short-term paper: **maturity transformation without deposit insurance**. When asset-backed commercial paper markets froze in 2007, SIVs faced runs, and sponsoring banks took the assets back onto their own balance sheets.
:::
...
- The U.S. **leveraged loan** market reached about **US\$1.55 trillion** at the end of 2025; the U.S. **CLO** market exceeds **US\$1 trillion**.
...
- **FinTech** is older than your phone (telegraph 1866, ATM 1967, SWIFT 1973), but post-GFC regulation and the smartphone produced the modern wave.
- A decade ago the consensus was that FinTechs would *eat* banks. By 2026 the more accurate view is: **incumbents kept the deposit franchise; the contest is over who owns the customer interface.**
...
- **Neobanks** are still banks: to take deposits in Australia they need an **ADI licence** from APRA. The **Restricted ADI** pathway (since 2018) lowers the entry barrier.

## Generative AI in banking

The wave none of the textbooks anticipated. Since **ChatGPT** (Nov 2022), banks have moved from cautious pilots to scaled deployment: customer service, code generation, and risk and compliance work such as triaging AML alerts.
...
- CDR launched in **banking (2020)**, expanded to **energy (2022)**; non-bank lenders share customer data from November 2026.
- Customers consent to share their data with an accredited firm, for a set purpose and up to 12 months; their bank shares it through a standard API.
- It erodes a bank's information advantage over its own customers, lowering switching costs. @he_open_2023 show it could leave the industry better off yet borrowers worse off.
...
::: {.callout-warning title="The worry for banks"}
...
- **Live retail CBDCs**: the Bahamas, Nigeria and Jamaica, all with modest adoption. China's e-CNY is the largest pilot; since January 2026 its wallet balances pay interest and sit on banks' balance sheets.
- **In design**: the digital euro (possible first issuance in 2029) and the digital pound (no decision yet). The U.S. has ruled out a CBDC by executive order.
- **Australia**: wholesale first. After the eAUD pilot (2023), the RBA and the Digital Finance CRC ran **Project Acacia** (2024 to 2026), issuing pilot wholesale CBDC to settle tokenised assets.

# Wrap-up

## Risk migration this semester
