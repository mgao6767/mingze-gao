...
author: "Dr. Mingze Gao (MQBS) and Freda Shi (CBA)"
...
Freda Shi is a Senior Manager in the Group Treasury Collateral Funding team at the Commonwealth Bank of Australia (CBA). She is responsible for managing the Group’s collateral portfolio and supporting funding and liquidity optimisation across the bank.

Before her current role, Freda worked in CBA’s Treasury Finance Product Control team and previously at BNY Mellon as a Lead Analyst in the Corporate Trust team focusing on securitisation analytics. She began her career at PwC as a Consultant in financial services.

Freda’s expertise covers treasury management, funding and liquidity, securitisation, and financial analytics. She holds a Master’s degree in Accounting from the University of New South Wales.
...
Central to bank risk management is credit risk.
...
@irani_rise_2021 provides a good summary of the bank loan sales market.
