...
7. A swap that involves swapping an obligation to pay interest, at a fixed or floating rate, for payments representing the total return on a loanor a bond of a specified amount is a(n):
