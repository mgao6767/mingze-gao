...
(b)
If a 95 per cent confidence limit is required, then 95 per cent of the area will be 1.96 standard deviations (1.96 $\sigma$) from the mean. Thus, the maximum adverse yield change expected for this zero-coupon bond is an increase of 34.40 basis points (5+1.96 × 15) in interest rates.
:::
:::
