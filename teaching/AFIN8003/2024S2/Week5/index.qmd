...
That is, the potential daily loss in earnings on the $1 million position is $15,210 if the 1 bad day in 100 occurs tomorrow.
...
\text{DEAR (aggregate)} &= \sqrt{\text{D}_1^2 + \text{D}_2^2 + \text{D}_3^2 + 2 \cdot \text{D}_1 \cdot \text{D}_2 \cdot \rho_{12} + 2 \cdot \text{D}_1 \cdot \text{D}_3 \cdot \rho_{13} + 2 \cdot \text{D}_2 \cdot \text{D}_3 \cdot \rho_{23}} \\
 &= \sqrt{15210^2 + 13164^2 + 46600^2 + 2 \cdot 15210 \cdot 13164 \cdot (-0.2) 
 + 2 \cdot 15210 \cdot 46600 \cdot (0.4) + 2 \cdot 13164 \cdot 46600 \cdot (0.1)} \\
 &= 56433
\end{aligned}
$$

That is, this FI with the three positions in fixed-income securities, FX, and equities has an aggregate DEAR of $56,433.
