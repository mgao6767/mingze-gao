...
In last week, we discussed [interest rate risk](https://mingze-gao.com/teaching/AFIN8003/2026S1/Week4/): changes in interest rates could affect a FI's income and net worth.
...
- potential adverse move (in yield) is 23.3bps (i.e., 0.00233 in decimal).
...
- **UK**: Basel 3.1 (FRTB) is being phased in from 2026.
- **US**: The "Basel III Endgame" proposal has been substantially scaled back; final implementation timeline remains uncertain as of 2026.
- **Australia**: APRA has delayed the effective date of the revised __APS 116 Capital Adequacy: Market Risk__ to 2026. Currently, Australian banks using IMA measure market risks based on VaR.
...
::: {.callout-important}
Banks' IMA for market risk has historically been based on VaR. Under FRTB, it will be based on ES. Australia's transition to the ES-based framework is underway in 2026.
Therefore, only the ES-based IMA is described here.
:::
